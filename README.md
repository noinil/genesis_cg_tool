# genesis_cg_julia
This project helps you prepare topology and coordinate file for coarse-grained simulations in the MD package Genesis.
...
usage: aa_2_cg.jl [--force-field-protein FORCE-FIELD-PROTEIN]
                  ...
                  [--3spn-param _3SPN-PARAM] [--protein-DNA-Go]
                  [--pwmcos] [--pwmcos-scale PWMCOS-SCALE]
                  [--pwmcos-shift PWMCOS-SHIFT] [--pwmcos-ns] [--psf]
                  [--cgpdb] [--cgconnect] [--cgRNA-phosphate-Go]
                  [-p PFM] [--test-local-only] [--patch PATCH]
...
optional arguments:
  ...
  --use-safe-dihedral USE-SAFE-DIHEDRAL
                        ...
                        1) remove dih w/ large angles; 2) sin(kθ)
                        type; 3) sin^3(θ) type. (type: Int64, default:
                        0)
